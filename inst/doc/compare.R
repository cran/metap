...
###################################################
### code chunk number 1: compare.Rnw:168-169
###################################################
cancel <- c(0.001, 0.001, 0.999, 0.999)


###################################################
### code chunk number 2: compare.Rnw:173-191
###################################################
library(metap)
data(validity)
...
###################################################
### code chunk number 3: compare.Rnw:218-226
###################################################
...
###################################################
### code chunk number 5: compare.Rnw:369-378
###################################################
   kvals <- c(4, 5, 6, 8, 10, 15, 20)
   pvals <- c(0.2, 0.3, 0.3679, 0.4, 0.5, 0.6)
   dat <- rbind(
